        ...
        return list.map((item, index) => (
            <tr key={index}>
                <td><Field name={`${this.props.field}[${index}].name`} component={Input} 
                    placeholder='Informe um nome' readOnly={this.props.readOnly} /></td>
                <td><Field name={`${this.props.field}[${index}].value`} component={Input} 
                    placeholder='Informe um valor' readOnly={this.props.readOnly}/></td>
                    ...
                    <table className='table'>
                        <thead>
                            <tr>
                                ...
                                <th className='table table-actions'>Ações</th>
                            </tr>
                        </thead>
                        <tbody>
                            { this.renderRows() }
